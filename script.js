		...
		this.chars.forEach((c, i) => {
			...
			if (lit < 30) {
				if (i === this.chars.length - 1) {
					fill(210, 30, 100); // Darker blue for tail
				} else {
					fill(210, 100, 90); // Lighter blue
				}
			}
...
function createStreams() {
	...
	for (let i = 0; i < window.innerWidth; i += charSize) {
...
setup(); // Call setup function after defining it